...
if st.session_state.clients:
    ...
    # Get the current date and set the weekday to Sunday
    today = datetime.date.today()
    sunday = today - datetime.timedelta(days=today.weekday())
    
    # Use the date_input() function with the Sunday date as the default
    booking_date = st.date_input("Select a Date for Booking", value=sunday, format="MM/DD/YYYY")
